...
case "${AW1000_QMI_STACK:-vendor}" in
	vendor)
		"$GITHUB_WORKSPACE/AW1000-NSS/scripts/fix-qmodem-vendor-qmi.sh"
		;;
	qosmio-nss)
		"$GITHUB_WORKSPACE/AW1000-NSS/scripts/fix-qmodem-qosmio-nss.sh"
		;;
	*)
		echo "ERROR: unsupported AW1000_QMI_STACK: ${AW1000_QMI_STACK}" >&2
		exit 1
		;;
esac
